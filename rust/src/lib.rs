//! Windissect-generated Rust FFI bindings for InputApp.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "97382E2898574854BA4E54B4B748AE5A";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1785168495;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 13] = [73, 110, 112, 117, 116, 65, 112, 112, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1785168495 { return 0; }
