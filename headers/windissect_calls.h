...
static constexpr wchar_t module_name[13] = {0x0049, 0x006E, 0x0070, 0x0075, 0x0074, 0x0041, 0x0070, 0x0070, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1785168495U || rva >= image_size) return nullptr;
return base + rva;
}
